...
This project is a Node.js/TypeScript conversion and enhancement of the original Python-based "AI Codebase Knowledge Builder". (If you have a link to the original, add it here: `[link to original repo]`)
